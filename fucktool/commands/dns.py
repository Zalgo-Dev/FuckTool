...
from core.colors import RED, LIGHT_ORANGE, YELLOW, RESET, GRAY, WHITE, GREEN, LIGHT_BLUE, NEON_GREEN, BLUE, NEON_BLUE, CYAN, LIGHT_GREEN
from urllib.parse import urlparse

def handle_dns(args):
    if len(args) != 1:
        print(f"\n  {RED}[{LIGHT_ORANGE}Error{RED}] {YELLOW}Usage: dns <ip/domain>{RESET}\n")
        return
